...
public class SmartPhone extends Device
{
    ...
    public SmartPhone(String manufacturer, String model, double price, int serialNum, double screenSizeInch, int cameraMp, String operatingSystem, int memoryGb, String colour)
    {
